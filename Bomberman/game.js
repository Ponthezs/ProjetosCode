...
scene('game', ({level, score}) => {
    ...
    const levelCfg = {
        width: 26,
        height: 26,
        a: [sprite('wall-steel'), 'wall-steel', solid(), 'wall'], //PAREDE DE AÇO
        z: [sprite('brick-red'), 'wall-brick', solid(), 'wall'],//TIJOLO VERMELHO
        d: [sprite('brick-red'), 'wall-brick-dool', solid(), 'wall'],
        b: [sprite('wall-gold'), 'wall-gold', solid(), 'wall'], //PAREDE DE OURO
        w: [sprite('brick-wood'), 'wall-brick', solid(), 'wall'],//PAREDE DE MADEIRA
        p: [sprite('brick-wood'), 'wall-brick-dool', solid(), 'wall'],
        t: [sprite('door'), 'door', 'wall'],//PORTA
