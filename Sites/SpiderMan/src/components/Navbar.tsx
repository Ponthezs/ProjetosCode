...
import { Volume2, VolumeX, Shield, Globe, Compass, Sliders, Zap, Film } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({ activeSection, onNavigate }) => {
  ...
  const navItems = [
    ...
    { id: 'media-section', label: 'FILMES & JOGOS', icon: Film },
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        >
          <div className="relative flex items-center justify-center w-10 h-10 rounded-full bg-red-600/20 border border-red-500/40 group-hover:border-red-500 group-hover:shadow-[0_0_20px_rgba(229,9,20,0.8)] transition-all overflow-hidden p-0.5">
            <img
              src="/spiderman_face_logo_clean.png"
              alt="Spider-Man Logo"
