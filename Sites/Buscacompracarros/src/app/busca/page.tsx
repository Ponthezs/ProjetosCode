...
function SearchResultsContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/90 p-4 sm:p-5 rounded-3xl border border-slate-800 space-y-4 shadow-xl">
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            <input
              ...
              placeholder="🔎 Pesquise por marca, modelo, versão (ex: Corolla XEi 2022)..."
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 bg-slate-900/60 p-3.5 rounded-2xl border border-slate-800 text-xs">
            <div className="text-slate-300 font-medium flex items-center gap-2">
              ...
              <span>Encontrados <strong className="text-white font-extrabold">{ads.length}</strong> veículos compatíveis</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <option value="score_desc">Maior Nota (Score)</option>
              </select>
            </div>
          </div>
          ...
          {ads.length === 0 ? (
            <div className="bg-slate-900/80 p-12 rounded-3xl border border-slate-800 text-center space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Nenhum veículo encontrado com os filtros atuais</h3>
              <p className="text-sm text-slate-400 max-w-md mx-auto">
                Tente ajustar a faixa de preço, ano ou remover palavras específicas da sua busca.
              </p>
              <button
                onClick={handleResetFilters}
    ...
    <Suspense
      fallback={
        <div className="flex items-center justify-center py-20 text-slate-400 gap-2">
          ...
          <span>Carregando resultados de pesquisa...</span>
        </div>
      }
    >
